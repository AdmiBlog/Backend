...
class DeleteTimelineRequestBody(BaseModel):
    time: int
...
async def getDb():
    ...
    return mongoClient[os.getenv("DB_NAME") or "AdmiBlog"]["Timeline"]
...
@app.delete("/deleteTimeline")
async def deleteTimeline(
    body: DeleteTimelineRequestBody,
...
@app.put("/updateTimeline")
async def updateTimeline(
