    ...
    try:
        ...
        for post in (
            ...
            ET.SubElement(url, "loc").text = (
                f"https://blog.qyadbr.top/posts/{post['slug']}"
            )
        ...
        url = ET.SubElement(root, "url")
        ET.SubElement(url, "loc").text = "https://blog.qyadbr.top"
        ...
        url = ET.SubElement(root, "url")
        ET.SubElement(url, "loc").text = "https://blog.qyadbr.top/speaks"
        ET.SubElement(url, "lastmod").text = datetime.datetime.now().strftime(
            "%Y-%m-%d"
        )
        ET.SubElement(url, "changefreq").text = "daily"
        ...
        url = ET.SubElement(root, "url")
        ET.SubElement(url, "loc").text = "https://blog.qyadbr.top/links"
        ET.SubElement(url, "lastmod").text = datetime.datetime.now().strftime(
            "%Y-%m-%d"
        )
        ET.SubElement(url, "changefreq").text = "daily"
        ET.SubElement(url, "priority").text = "0.8"
        url = ET.SubElement(root, "url")
        ET.SubElement(url, "loc").text = "https://blog.qyadbr.top/about"
        ET.SubElement(url, "lastmod").text = datetime.datetime.now().strftime(
            "%Y-%m-%d"
        )
        ET.SubElement(url, "changefreq").text = "daily"
